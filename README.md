...
# Publications in PhD
- [Topology Reconstruction of circular planar passive resistive network using resistance distance metric.](Accepted with minor revisions) <br /> Shivanagouda Biradar, Deepak U. patil  <br />
